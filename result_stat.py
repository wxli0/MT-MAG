...
def calc_stats_per_rank(path, path_true, ranks, ignore_taxa =[], ignore_indices = []):
    ...
    for rank in ranks:
        ...
        WAs.append(WA)
        PRs.append(PR)
        print("at", rank, "CA:", CA, "AA:", AA, "WA:", WA, "PR:", PR)
    print("avg CA:", stat.mean(CAs), "avg AA:", stat.mean(AAs), "avg WA:", stat.mean(WAs), "avg PR:", stat.mean(PRs))
...
print("====== HGR result ======")
path_true2 = "./outputs-HGR-r202/HGR-r202-prediction-full-path.csv"
path2 = "~/Desktop/HGR-r202-prediction-full-path.csv"
...
# true_path1 = "./outputs-GTDB-r202/GTDB-r202-prediction-full-path.csv"
